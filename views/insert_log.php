                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <br><br> 建制於場域:<br>
                      <select required="required" id="controller_in_area" onchange="controller_area_select();">
                      </select>
                      <br><br> 建制於群組:<br>
                      <select required="required" id="controller_in_group" onchange="controller_group_select();">
                  </select>
                    </form>
                  </div>
                  <div class="modal-footer">
