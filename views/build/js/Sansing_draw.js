$(document).ready(function(){
	window.draw=function(data,typ) {
			...
			else if(typ=="soil_humi"){
				label_setting = "Soil's Humidity";
			}
			else if(typ=="CO2"){
				label_setting = "CO2";
			}
			else if(typ=="air_temp"){
				label_setting = "Air's Temperature";
			}
			else if(typ=="air_humi"){
				label_setting = "Air's Humidity";
			}
			else if(typ=="light"){
				label_setting = "Light";
			}
			else if(typ=="wind_dir"){
				label_setting = "Wind's Direction";
			}
			else if(typ=="wind_sp"){
				label_setting = "Wind's Speed";
			}
			else if(typ=="rain_h"){
				label_setting = "Rain per hour";
			}else if(typ=="rain_d"){
				label_setting = "Rain per Day";
			}
			else {
